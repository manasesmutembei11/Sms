...
{
    internal class SubjectRepository : RepositoryBase<Subject, Guid>, ISubjectRepository
    {
        public SubjectRepository(AppDbContext context) : base(context)
        {
        }
        public Task<PagedList<Subject>> GetPagedListAsync(PagingParameters pagingParameters, bool trackChanges)
        {
            ...
            return PagedList<Subject>.ToPagedListAsync(data, pagingParameters.PageNumber, pagingParameters.PageSize);
        }
