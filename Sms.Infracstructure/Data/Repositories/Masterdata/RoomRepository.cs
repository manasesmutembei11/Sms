...
{
    internal class RoomRepository : RepositoryBase<Room, Guid>, IRoomRepository
    {
        public RoomRepository(AppDbContext context) : base(context)
        {
        }
        public Task<PagedList<Room>> GetPagedListAsync(PagingParameters pagingParameters, bool trackChanges)
        {
            ...
            return PagedList<Room>.ToPagedListAsync(data, pagingParameters.PageNumber, pagingParameters.PageSize);
        }
        public override void Delete(Room item)
        {
