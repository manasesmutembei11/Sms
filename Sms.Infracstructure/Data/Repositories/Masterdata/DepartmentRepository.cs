...
{
    internal class DepartmentRepository : RepositoryBase<Department, Guid>, IDepartmentRepository
    {
        public DepartmentRepository(AppDbContext context) : base(context)
        {
        }
        public Task<PagedList<Department>> GetPagedListAsync(PagingParameters pagingParameters, bool trackChanges)
        {
            ...
            return PagedList<Department>.ToPagedListAsync(data, pagingParameters.PageNumber, pagingParameters.PageSize);
        }
